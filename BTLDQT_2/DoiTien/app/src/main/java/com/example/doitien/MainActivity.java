...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // thay đổi dữ liệu trên spinner 2
        spinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                String url = "http://img.geonames.org/flags/x/" + ListCountry.get(i).getCountryCode().toLowerCase() + ".gif";
...
//            ListCountry  = countries;
    ...
    // Sử dụng AsyncTask<Void, Void, Void> để dùng được doInBackground(Void... void)
    ...
    {
        float n1,n2,u1,f;
        n1=Float.parseFloat(secondfrom); // input số tiền muốn nhập
        n2=Float.parseFloat(secondto); // ouput số tiền đã đổi
